...
.method static varargs a(Landroid/content/pm/PackageInfo;[Lcsm;)Lcsm;
    .locals 5
    ...
    invoke-direct {v3, v0}, Lcvm;-><init>([B)V
    ...
    invoke-virtual {v4, v3}, Lcsm;->equals(Ljava/lang/Object;)Z
...
.method private static b(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {}, Ldkc;->T()Ljava/util/Set;
    ...
    :cond_1
    invoke-static {}, Ldkc;->U()Ljava/util/Set;
...
.method public final a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p1, v2}, Lcne;->a(Landroid/content/pm/PackageInfo;[Lcsm;)Lcsm;
    ...
    :cond_0
    new-array v2, v0, [Lcsm;

    sget-object v3, Lczx;->a:[Lcsm;
...
.method public final a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    .line 1000
    :cond_1
    invoke-static {p1}, Lcnd;->a(Landroid/content/pm/PackageManager;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {v1, v3}, Lcne;->b(Landroid/content/pm/PackageInfo;Z)Z
    ...
    :cond_2
    invoke-static {v1, v0}, Lcne;->b(Landroid/content/pm/PackageInfo;Z)Z
