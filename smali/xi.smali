...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 47
    iput-object p1, p0, Lxi;->c:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lje;->a()Landroid/graphics/drawable/Drawable;
    ...
    .line 75
    invoke-direct {p0, v0, p2}, Lxi;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Lje;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lxi;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 100
    iput-object v1, p0, Lxi;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 51
    iget-object v0, p0, Lxi;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lxi;->b:[I

    invoke-static {v0, p1, v1, p2, v3}, Labi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Labi;

    move-result-object v4

    .line 54
    invoke-virtual {v4, v3}, Labi;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 56
    iget-object v5, p0, Lxi;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lxi;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 59
    :cond_2
    invoke-virtual {v4, v9}, Labi;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 61
    iget-object v1, p0, Lxi;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lxi;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
