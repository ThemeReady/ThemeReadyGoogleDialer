...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcnd;->a:Z

    sput-boolean v1, Lcnd;->d:Z
    ...
    sput-object v0, Lcnd;->f:Ljava/lang/Object;

    sput-object v2, Lcnd;->g:Ljava/lang/String;

    sput-object v2, Lcnd;->h:Ljava/lang/Integer;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcnd;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcnd;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1, v1}, Lcnd;->a(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {v3}, Lcnd;->a(Landroid/content/pm/PackageManager;)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual {v2, v1, v4}, Lcne;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    :cond_2
    invoke-virtual {v2, v1, v0}, Lcne;->a(Landroid/content/pm/PackageInfo;Z)Z
...
.method public static a(Landroid/content/pm/PackageManager;)Z
    ...
    .prologue
    .line 0
    invoke-static {p0}, Lcnd;->b(Landroid/content/pm/PackageManager;)Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lcnd;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private static b(Landroid/content/pm/PackageManager;)Z
    ...
    .line 0
    sget-object v2, Lcnd;->f:Ljava/lang/Object;
    ...
    new-array v4, v4, [Lcsm;

    const/4 v5, 0x0

    sget-object v6, Lczx;->a:[Lcsm;
    ...
    invoke-static {v3, v4}, Lcne;->a(Landroid/content/pm/PackageInfo;[Lcsm;)Lcsm;
...
.method public static c(Landroid/content/Context;)I
    ...
    .line 1000
    sget-object v3, Lcnd;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v5, Lcnd;->f:Ljava/lang/Object;

    monitor-enter v5

    :try_start_1
    sget-object v3, Lcnd;->g:Ljava/lang/String;
    ...
    sput-object v3, Lcnd;->g:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    sput-object v3, Lcnd;->h:Ljava/lang/Integer;
    :try_end_2
    ...
    :goto_2
    :try_start_3
    sget-object v3, Lcnd;->h:Ljava/lang/Integer;
    ...
    sget-object v2, Lcnd;->g:Ljava/lang/String;
    ...
    .line 2000
    invoke-static {p0}, Ldkc;->at(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_6

    sget-object v5, Lczx;->a:[Lcsm;

    invoke-static {v3, v5}, Lcne;->a(Landroid/content/pm/PackageInfo;[Lcsm;)Lcsm;
    ...
    invoke-static {v5, v6}, Lcne;->a(Landroid/content/pm/PackageInfo;[Lcsm;)Lcsm;
    ...
    :try_start_9
    new-array v6, v6, [Lcsm;

    const/4 v7, 0x0

    aput-object v5, v6, v7

    invoke-static {v3, v6}, Lcne;->a(Landroid/content/pm/PackageInfo;[Lcsm;)Lcsm;
...
.method public static d(Landroid/content/Context;)V
    ...
    sget-object v1, Lcmy;->d:Lcmy;

    const-string v2, "e"

    invoke-virtual {v1, p0, v0, v2}, Lcmy;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, v0}, Lcmz;-><init>(I)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lcna;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static e(Landroid/content/Context;)V
    ...
    sget-object v0, Lcnd;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
