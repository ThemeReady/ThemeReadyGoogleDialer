...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcrv;->a:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcrv;->d:Ljava/util/List;

    sget-object v0, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v0, p0, Lcrv;->e:Ljava/util/List;

    sget-object v0, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v0, p0, Lcrv;->f:Ljava/util/List;

    :goto_0
    return-void

    :cond_0
    sget-object v0, Lcrw;->b:Ldiy;
    ...
    invoke-direct {v1, v4, v2, v3}, Lcrz;-><init>(IJ)V

    iput-object v1, p0, Lcrv;->g:Lcrz;
...
.method public static a()Lcrv;
    .locals 2

    sget-object v1, Lcrv;->a:Ljava/lang/Object;
...
.method private static b()I
    ...
    sget-object v0, Lcrv;->h:Ljava/lang/Integer;

    if-nez v0, :cond_0

    :try_start_0
    invoke-static {}, Ldkc;->H()Z

    move-result v0

    if-eqz v0, :cond_1

    sget-object v0, Lcrw;->a:Ldiy;
    ...
    sput-object v0, Lcrv;->h:Ljava/lang/Integer;
    :try_end_0
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;I)V
    ...
    invoke-virtual {v2, v0}, Lcrz;->b(Ljava/lang/String;)Z
    ...
    invoke-static {v2, v5}, Ldkc;->e(II)Ljava/lang/String;
    ...
    sget-object v4, Lcry;->a:Landroid/content/ComponentName;
    ...
    invoke-static {v6, v7}, Ldkc;->e(II)Ljava/lang/String;
    ...
    invoke-static {v7, v8}, Ldkc;->e(II)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Ldkc;->au(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lcrv;->c:Ljava/util/List;
    ...
    iget-object v3, v0, Lcrv;->d:Ljava/util/List;
    ...
    iget-object v3, v0, Lcrv;->e:Ljava/util/List;
    ...
    iget-object v3, v0, Lcrv;->f:Ljava/util/List;
    ...
    invoke-virtual {v2, v0}, Lcrz;->a(Ljava/lang/String;)Ljava/lang/Long;
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-static {p1, v1}, Ldkc;->n(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p4}, Lcrv;->a(Landroid/content/ServiceConnection;)Ljava/lang/String;
